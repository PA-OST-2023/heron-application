...
class AudioProcessor:
    ...
    def process_filter(self, input, f_min, f_max):        # Cannot be sped up using numba due to scipy functions
...
@jit
def compressor(input, threshold=-20, ratio=2, make_up_gain=0):
